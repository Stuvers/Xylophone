...
function HitBar(note) {
	...
	if (note == "C1") {
		audio = new Audio("xylophone-c.wav");
		audio.play();
	}
	else if (note == "D2") {
		audio = new Audio("xylophone-d1.wav");
		audio.play();
	}
	else if (note == "E3") {
		audio = new Audio("xylophone-e1.wav");
		audio.play();
	}
	else if (note == "F4") {
		audio = new Audio("xylophone-f.wav");
		audio.play();
	}
	else if (note == "G5") {
		audio = new Audio("xylophone-g.wav");
		audio.play();
	}
	else if (note == "A6") {
		audio = new Audio("xylophone-a.wav");
		audio.play();
	}
	else if (note == "B7") {
		audio = new Audio("xylophone-b.wav");
		audio.play();
	}
	else if (note == "C8") {
		audio = new Audio("xylophone-c2.wav");
		audio.play();
	}	
}
